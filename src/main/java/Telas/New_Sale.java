...
public class New_Sale extends javax.swing.JFrame {
    ...
    private void applyDarkTheme() {
        configureTable(table_ShoppingCart);
    ...
    private void initComponents() {
        ...
        btn_searchCustomers = new javax.swing.JButton();
        ...
        btn_searchProducts = new javax.swing.JButton();
        ...
        btn_searchCustomers.setBackground(new java.awt.Color(0, 176, 80));
        btn_searchCustomers.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btn_searchCustomers.setForeground(new java.awt.Color(255, 255, 255));
        btn_searchCustomers.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_olho.png"))); // NOI18N
        btn_searchCustomers.setBorderPainted(false);
        btn_searchCustomers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_searchCustomersActionPerformed(evt);
            }
        });
        jPanel1.add(btn_searchCustomers, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 40, 50, 30));
        ...
        jPanel1.add(btn_searchCPF, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, 100, 30));
        ...
        jPanel1.add(txt_CPF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 110, 30));
        ...
        jPanel1.add(txt_Code, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 230, 70, 30));
        ...
        btn_searchProducts.setBackground(new java.awt.Color(0, 176, 80));
        btn_searchProducts.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btn_searchProducts.setForeground(new java.awt.Color(255, 255, 255));
        btn_searchProducts.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_olho.png"))); // NOI18N
        btn_searchProducts.setBorderPainted(false);
        btn_searchProducts.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_searchProductsActionPerformed(evt);
            }
        });
        jPanel1.add(btn_searchProducts, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, 50, 30));
        ...
        jPanel1.add(btn_searchCod, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 140, 30));
        ...
        jPanel1.add(btnDeleteProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 430, 30, 30));

        table_ShoppingCart.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 40, 720, 430));
    ...
    private void btn_searchCodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchCodActionPerformed
        ...
        if (product != null) {
            ...
            Products productsScreen = new Products();
            Customers customerScreen = new Customers();
            productsScreen.dispose(); // Fecha a janela Products
            customerScreen.dispose(); // Fecha a janela Products
    ...
    private void btn_searchProductsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchProductsActionPerformed
        // Abre a tela Home e exibe o card de produtos ("Card_Products").
        new Products().setVisible(true);
    }//GEN-LAST:event_btn_searchProductsActionPerformed

    private void btn_searchCustomersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchCustomersActionPerformed
        // TODO add your handling code here:
        new Customers().setVisible(true);
    }//GEN-LAST:event_btn_searchCustomersActionPerformed
    ...
    private javax.swing.JButton btn_searchCustomers;
    private javax.swing.JButton btn_searchProducts;
