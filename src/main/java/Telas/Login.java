...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        // Configurando os campos de texto para fundo branco e texto preto
        txt_user.setBackground(Color.WHITE);
        txt_user.setForeground(Color.BLACK);
        txt_user.setCaretColor(Color.BLACK); // Cor do cursor

        txt_password.setBackground(Color.WHITE);
        txt_password.setForeground(Color.BLACK);
        txt_password.setCaretColor(Color.BLACK); // Cor do cursor
    ...
    private void btn_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_loginMouseClicked
        ...
        String password = new String(txt_password.getPassword());  // use getPassword() para campos de senha

        if ("admin".equals(username) && "admin".equals(password)) {
            // Login bem-sucedido, prossiga para a próxima tela ou ação
